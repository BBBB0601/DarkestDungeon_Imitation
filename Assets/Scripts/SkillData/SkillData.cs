...
public class SkillData : ScriptableObject
{
    ...
    [SerializeField] private bool _useFixedDamage = false;       // 스킬 대미지 범위 사용 여부
    public bool UseFixedDamage => _useFixedDamage;
    ...
    public void Initialize(string skillName, SkillType skillType, bool[] usable,
                           ...
                           int acc, float dmg, float crit, bool monsterSkill, int minDmg, int maxDmg,
                           string note)
    {
        // 영웅 | 몬스터 공통 적용
